...
- Status: Proposed (implemented in a candidate patch; not merged or released)
- Date: 2026-09-05
...
## Follow-up before merging/promoting

Run pinned Rust/Flutter gates and the physical matrix in
