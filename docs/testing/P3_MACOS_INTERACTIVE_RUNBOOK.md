...
- Product PR: #55
- Product candidate SHA: `ba0b724cfd96bba2161518d50197358b7df35b57`
...
```bash
git fetch origin \
  validation/p3-s01-macos-native-evidence-ba0b724 \
  feat/p3-cross-platform-ui-macos

git switch --detach origin/validation/p3-s01-macos-native-evidence-ba0b724

git rev-parse ba0b724cfd96bba2161518d50197358b7df35b57
...
tools/macos/p3_s01_prepare.sh \
  ba0b724cfd96bba2161518d50197358b7df35b57 \
