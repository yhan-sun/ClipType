...
- [`ADR-0021`](0021-macos-synthetic-modifier-isolation.md) — Isolate macOS synthetic event state from physical modifier evidence while preserving fail-closed modifier checks.
