...
- [`ADR-0022`](0022-task-oriented-macos-settings-ux.md) — Task-oriented Flutter macOS settings, readiness, transactional shortcut presentation, and runtime build identity.
